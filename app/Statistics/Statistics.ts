...
import { getMedalsSummaryFromDBSet } from './utils';
...
export class Statistics {
  ...
  static async getMedalsStatistics(matchObject: MedalsChartParsedArgs) {
    ...
    let medalsList = medal ? [medal] : [...Object.values(Medal)];
  ...
  static getTopTeamsStatistics(matchObject: any) {}
}
